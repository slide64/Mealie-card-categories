      ...
      <div class="card-toolbar">
        ...
        ${t?B`<ha-select
            ...
            >
              ...
              ${this._categories().map(e=>B`<ha-list-item .value=${e.slug}>${e.name}</ha-list-item>`)}
            </ha-select>`:q}
        ${i?B`<ha-icon-button
