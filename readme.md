[INSTALLATION-GITHUB-FR.md](https://github.com/user-attachments/files/32345211/INSTALLATION-GITHUB-FR.md)
...
3. Dans **Dépôt**, saisissez :
   ...
   ```text
   https://slide64/Mealie-card-categories/mealie-card-categories
   ```
